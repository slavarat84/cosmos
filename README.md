<html>
    ...
    <body>
      <img src="https://img.freepik.com/premium-vector/space-logo_629862-268.jpg" width="50" height="50"/>
      <header>
            <p>Всім привіт цей сайт допоможе вам дізнатись більше про космос та косічний простір.
            До планет Сонячної системи буде невелике пояснення. Приємного перегляду.</p>
      ...
      <h1>Космічний простір</h1>
        <main>
            <h2 id="Mercury">Меркурій (Mercury)</h2>
<p>Мерку́рій — найближча до Сонця планета Сонячної системи. Обертається навколо Сонця за 87,969 земної доби.
Меркурій належить до внутрішніх планет, оскільки його орбіта лежить ближче до Сонця, ніж пояс астероїдів. Після позбавлення 
Плутона статусу планети Меркурій є найменшою планетою Сонячної системи.</p>
...
<tr>
<td style="border:1px solid black">Меркурій</td>
<td style="border:1px solid black">Сірий</td>
<td style="border:1px solid black">4865 км</td>
</tr>
</table>
   <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Mercury_in_color_-_Prockter07_centered.jpg/280px-Mercury_in_color_-_Prockter07_centered.jpg"/>
   <a href="https://uk.wikipedia.org/wiki/%D0%9C%D0%B5%D1%80%D0%BA%D1%83%D1%80%D1%96%D0%B9_(%D0%BF%D0%BB%D0%B0%D0%BD%D0%B5%D1%82%D0%B0)">Більше про Меркурій</a>
...
<p>Юпі́тер — п'ята від Сонця та найбільша планета Сонячної системи. Відстань Юпітера від Сонця змінюється в межах від 4,95 до 5,45 а. о. (740—814 млн км), середня відстань 5,203 а. о. (778 млн км). Разом із Сатурном, Ураном і Нептуном Юпітер класифікують як газового гіганта.</p>
<table style="border:1px solid black">
<tr>
<td style="border:1px solid black">Назва</td>
<td style="border:1px solid black">Колір</td>
